class GameMap {
    ...
    public constructor(stage: any) {
        ...
        this._map = [
            ...
            { image: "Ground_png", node: new _Node(2, 0, true) },
            ...
            { image: "Ground_png", node: new _Node(2, 1, true) },
            { image: "Wall_png", node: new _Node(3, 1, false) },
            ...
            { image: "Ground_png", node: new _Node(2, 2, true) },
            { image: "Wall_png", node: new _Node(3, 2, false) },
            ...
            { image: "Ground_png", node: new _Node(2, 3, true) },
            { image: "Wall_png", node: new _Node(3, 3, false) },
            ...
            { image: "Wall_png", node: new _Node(3, 4, false) },
            { image: "Wall_png", node: new _Node(4, 4, false) },
            { image: "Wall_png", node: new _Node(5, 4, false) },
            ...
            { image: "Ground_png", node: new _Node(6, 7, true) },
            ...
            { image: "Ground_png", node: new _Node(6, 8, true) },
